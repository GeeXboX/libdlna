...
static const struct {
  ...
  { &avc_ts_bl_cif30_aac_940, CT_MPEG_TRANSPORT_STREAM_DLNA_NO_TS,
    AVC_VIDEO_PROFILE_BL_CIF30_940, AVC_AUDIO_PROFILE_AAC },
  ...
  { &avc_ts_bl_cif15_aac_540, CT_MPEG_TRANSPORT_STREAM_DLNA_NO_TS,
    AVC_VIDEO_PROFILE_BL_CIF15_540, AVC_AUDIO_PROFILE_AAC },
...
dlna_registered_profile_t dlna_profile_av_mpeg4_part10 = {
  ...
  .extensions = "mov,mp4,3gp,3gpp,mpg,mpeg,mpe,mp2t,ts",
  .probe = probe_avc,
  .next = NULL
};
