...
#define MPEG_MIME_TYPE "video/mpeg"
#define MPEG4_MIME_TYPE "video/mp4"
#define MPEG4_TS_DLNA_MIME_TYPE "video/vnd.dlna.mpeg-tts"
#define ASF_MIME_TYPE "video/x-ms-asf"
#define THREE_GPP_MIME_TYPE "video/3gpp"

#define MPEG4_LABEL_QCIF15 "QCIF15"
#define MPEG4_LABEL_CIF15 "CIF15"
#define MPEG4_LABEL_CIF30 "CIF30"
#define MPEG4_LABEL_SD "SD"
...
typedef enum {
  MPEG4_AUDIO_PROFILE_INVALID,
  MPEG4_AUDIO_PROFILE_AAC,
  MPEG4_AUDIO_PROFILE_AAC_MULT5,
  MPEG4_AUDIO_PROFILE_AAC_LTP,
  MPEG4_AUDIO_PROFILE_HEAAC,
  MPEG4_AUDIO_PROFILE_HEAAC_MULT5,
  MPEG4_AUDIO_PROFILE_ATRAC,
  MPEG4_AUDIO_PROFILE_AMR,
  MPEG4_AUDIO_PROFILE_AMR_WB,
  MPEG4_AUDIO_PROFILE_MP2,
  MPEG4_AUDIO_PROFILE_MP3,
  MPEG4_AUDIO_PROFILE_AC3,
  MPEG4_AUDIO_PROFILE_G726,
} mpeg4_audio_profile_t;
...
static const struct {
  ...
  { &mpeg4_p2_ts_sp_mpeg1_l3, CT_MPEG_TRANSPORT_STREAM_DLNA_NO_TS,
    MPEG4_VIDEO_PROFILE_P2_SP_L3, MPEG4_AUDIO_PROFILE_MP3 },
  ...
  { &mpeg4_p2_ts_sp_ac3, CT_MPEG_TRANSPORT_STREAM_DLNA_NO_TS,
    MPEG4_VIDEO_PROFILE_P2_SP_L3, MPEG4_AUDIO_PROFILE_AC3 },
  ...
  { &mpeg4_p2_ts_sp_mpeg2_l2, CT_MPEG_TRANSPORT_STREAM_DLNA_NO_TS,
    MPEG4_VIDEO_PROFILE_P2_SP_L3, MPEG4_AUDIO_PROFILE_MP2 },
  ...
  { &mpeg4_p2_ts_asp_mpeg1_l3, CT_MPEG_TRANSPORT_STREAM_DLNA_NO_TS,
    MPEG4_VIDEO_PROFILE_P2_ASP_L5, MPEG4_AUDIO_PROFILE_MP3 },
  ...
  { &mpeg4_p2_ts_asp_ac3, CT_MPEG_TRANSPORT_STREAM_DLNA_NO_TS,
    MPEG4_VIDEO_PROFILE_P2_ASP_L5, MPEG4_AUDIO_PROFILE_AC3 },
  ...
  { &mpeg4_p2_ts_co_ac3, CT_MPEG_TRANSPORT_STREAM_DLNA_NO_TS,
    MPEG4_VIDEO_PROFILE_P2_ASP_L4, MPEG4_AUDIO_PROFILE_AC3 },
  ...
  { &mpeg4_p2_ts_co_mpeg2_l2, CT_MPEG_TRANSPORT_STREAM_DLNA_NO_TS,
    MPEG4_VIDEO_PROFILE_P2_ASP_L4, MPEG4_AUDIO_PROFILE_MP2 },
  ...
  { &mpeg4_p2_asf_sp_g726, CT_ASF,
    MPEG4_VIDEO_PROFILE_P2_SP_L3, MPEG4_AUDIO_PROFILE_G726 },
  { &mpeg4_p2_asf_asp_l5_so_g726, CT_ASF,
    MPEG4_VIDEO_PROFILE_P2_ASP_L5, MPEG4_AUDIO_PROFILE_G726 },
...
mpeg4_audio_get_profile (AVStream *as, AVCodecContext *ac)
{
  ...
  case CODEC_ID_AAC:
  {
    ...
    else if (audio_is_valid_aac_stereo (ac))
...
probe_mpeg4_part2 (AVFormatContext *ctx)
{
  ...
  ap = mpeg4_audio_get_profile (codecs->as, codecs->ac);
  if (ap == MPEG4_AUDIO_PROFILE_INVALID)
    goto probe_mpeg4_end;
